...
declare module dexie {
    ...
    type TransactionMode = 'r' | 'r!' | 'r?' | 'rw' | 'rw!' | 'rw?';
...
// Typescript 2.1 to allow extension of the Dexie API.
    ...
    export module Dexie {
        ...
        interface Promise<T> {
            ...
            // TODO solve: toStringTag is not defined in ES5
        ...
        interface DexieEventSet {
            ...
            addEventType (events: {[eventName: string]: ('asap' | [(f1: Function, f2: Function) => Function, Function])}): Dexie.DexieEvent;
        }
        ...
        class OpenFailedError extends DexieError {
            constructor(msg?: string, inner?: Object);
